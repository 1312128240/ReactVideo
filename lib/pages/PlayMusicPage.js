        ...
        return (
            <View style={{flex: 1,}}>
                ...
                <View style={musicStyle.topActionbar}>
                    <Image source={require('../imgs/back.png')} style={musicStyle.toolbarIv}/>
                    <Text>{this.state.songInfor.title}</Text>
                </View>
        ...
        return(
            <View style={{height:160,justifyContent:'space-around'}}>
                ...
                <View style={{flexDirection:'row',alignItems:'center'}}>
                    <Text style={musicStyle.tvTimer}>{millisToMinute(this.state.currentDuration)}</Text>
                      <Slider  style={{flex: 1}}
